...
<div class="app">
    ...
    <main class="main">
        ...
        <header class="page-header">
            ...
            <div>
                <h1>Cursos</h1>
                <p>Aprenda a investir e evolua seus conhecimentos.</p>
            </div>
        ...
        <section class="hero-grid">
            ...
            <div class="continue-card">
                ...
                <div class="continue-content">
                    ...
                    <div class="course-thumb large-thumb">
        ...
        <section class="filter-section">
            ...
            <div class="filters">
                ...
                <button class="filter" data-category="iniciante">
                    Iniciante
                </button>

                <button class="filter" data-category="renda">
                    Renda Fixa
                </button>

                <button class="filter" data-category="fiis">
                    FIIs
                </button>

                <button class="filter" data-category="acoes">
                    Ações
                </button>

                <button class="filter" data-category="cripto">
                    Cripto
                </button>
        ...
        <section class="recommended">
            ...
            <div class="section-header">
                ...
                <div>
                    ...
                    <p>
                        Conteúdos selecionados com base
                        no seu nível.
                    </p>
                </div>
            ...
            <div class="courses-grid">
                ...
                >
                    ...
                    <div class="course-thumb beginner-thumb">
            ...
            <div class="learning-paths">
                ...
                <div class="section-header">
                    ...
                    <div>
                        ...
                        <p>
                            Continue evoluindo passo a passo.
                        </p>
                    </div>
